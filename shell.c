...
int main (int argc, char *argv[])
{
	...
	// int MAX_TOKENS = (LARGO_MAX_BUFFER - 1)/2 + LARGO_MAX_BUFFER%2; // La cantidad máxima de palabras que puede haber es la cantidad de caracteres no nulos dividida en 2 (en el caso de que hayan solo palabras de largo 1 separadas por 1 espacio), redondeada hacia arriba.
	...
	// {
	// 	printf("%s", PROMPT);
	// 	fgets(string_leida, LARGO_MAX_BUFFER, stdin);
